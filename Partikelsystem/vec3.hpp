...
inline point3 random_point() {
    ...
    float randX = 2.6f + static_cast<float>(rand()) / (RAND_MAX / (4.0f - 2.6f));
    float randY = 3.8f + static_cast<float>(rand()) / (RAND_MAX / (4.0f - 3.8f));
    float randZ = -3.0f + static_cast<float>(rand()) / (RAND_MAX / (3.0f - (-3.0f)));
